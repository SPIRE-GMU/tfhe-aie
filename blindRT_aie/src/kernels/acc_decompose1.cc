...
//input_stream_int32* sin1,  reordered acc
//input_stream_int32* sin2,  bootstrapping key  //2025.Mar.24 no more need bk from this port.
//output_stream_int32* sout1, polynomial poduc
//output_stream_int32* sout2  transmit
