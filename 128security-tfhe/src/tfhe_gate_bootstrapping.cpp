...
// this is the default and recommended parameter set, but concret boolean library use a different one below
...
//     static const int32_t N = 1024; // degree of the polynomials 512
//     static const int32_t k = 1;   // number of polynomials in the mask 2
//     static const int32_t n = 630; // number of LWE samples in the input/output ciphertexts 586
//     static const int32_t bk_l = 3; // number of rows in the bootstrapping key 2
//     static const int32_t bk_Bgbit = 7; // log_2(Bg) 8
//     static const int32_t ks_basebit = 2;
//     static const int32_t ks_length = 8;
...
static TFheGateBootstrappingParameterSet *default_128bit_gate_bootstrapping_parameters() {
    // These are the parameter set provided in CONCRET WAHC-2020.
    static const int32_t N = 512; // degree of the polynomials 512
    static const int32_t k = 2;   // number of polynomials in the mask 2
    static const int32_t n = 586; // number of LWE samples in the input/output ciphertexts 586
    static const int32_t bk_l = 2; // number of rows in the bootstrapping key 2
    static const int32_t bk_Bgbit = 8; // log_2(Bg) 8
    static const int32_t ks_basebit = 2;
    static const int32_t ks_length = 8;
    static const double ks_stdev = pow(2.,-15); //standard deviation
    static const double bk_stdev = pow(2.,-25);; //standard deviation
